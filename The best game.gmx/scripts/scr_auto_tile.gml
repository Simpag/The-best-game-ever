...
iw          = sprite_width;
w_left      = (place_meeting(x-iw,y,obj_ground));
w_right     = (place_meeting(x+iw,y,obj_ground));
w_up        = (place_meeting(x,y-iw,obj_ground));
w_down      = (place_meeting(x,y+iw,obj_ground));
w_upleft    = (place_meeting(x-iw,y-iw,obj_ground));
w_downleft  = (place_meeting(x-iw,y+iw,obj_ground));
w_upright   = (place_meeting(x+iw,y-iw,obj_ground));
w_downright = (place_meeting(x+iw,y+iw,obj_ground));
